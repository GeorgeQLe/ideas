...
**Acceptance Criteria:**
- [ ] `npm test` runs and passes in snipvault
- [ ] `npm test` runs and passes in formforge
- [ ] `npm test` runs and passes in pulseboard
- [ ] All three have vitest.config.ts with correct path aliases
- [ ] Existing driftlog `npm test` still passes
